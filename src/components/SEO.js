    ...
    return (
        <Helmet
          ...
          meta = {[
            ...
            {itemprop: "image", "content" : get(this.props.postContent.frontmatter, 'image', null) === null ? "" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.sizes.srcWebp},
            ...
            {property: "og:image", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? "" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.sizes.srcWebp},
            {property: "og:image:secure_url", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? "" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.sizes.srcWebp},
            ...
            // Twitter
            {name: "twitter:card", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? "" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.sizes.srcWebp},
            {name: "twitter:image:src", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? "" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.sizes.srcWebp},

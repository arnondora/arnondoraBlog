    ...
    return (
        <Helmet
          ...
          meta = {[
            ...
            {property: "og:image:width", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? 0 : this.props.postContent.frontmatter.image.childImageSharp.resolutions.width},
            {property: "og:image:height", "content": get(this.props.postContent.frontmatter, 'image', null) === null ? 0 : this.props.postContent.frontmatter.image.childImageSharp.resolutions.height},

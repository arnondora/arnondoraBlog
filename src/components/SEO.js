    ...
    return (
        <Helmet
          ...
          meta = {[
            ...
            {itemprop: "image", "content" : this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.original.src},
            ...
            {property: "og:image", "content": this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.original.src},
            {property: "og:image:secure_url", "content": this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.original.src},
            {property: "og:image:width", "content": this.props.postContent.frontmatter.image.childImageSharp.original.width},
            {property: "og:image:height", "content": this.props.postContent.frontmatter.image.childImageSharp.original.height},
            ...
            // Twitter
            {name: "twitter:card", "content": this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.original.src},
            {name: "twitter:image:src", "content": this.props.siteMetadata.siteUrl + this.props.postContent.frontmatter.image.childImageSharp.original.src},

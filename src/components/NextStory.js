...
const SuperWrapper = styled.div`
  background-color: ${props => props.isNight? props.theme.night_lightBackground : props.theme.secondaryBackground};
  border-top: 1px solid ${props => props.isNight? props.theme.night_secondaryBorder : props.theme.secondaryBorder};
  border-bottom: ${props => props.hasRelated ? '1px solid ' + props.isNight ? props.theme.night_secondaryBorder : props.theme.secondaryBorder : 'none'};
  padding-top: 35px;
  padding-bottom: 35px;
`
...
const PreviousStoryContainer = StoryContainer.extend`
  ...
  ${Label} {
    color: ${props => props.isNight ? props.theme.night_text_normal : "#666666"};
  }
